...
~~~sh
# getting the code
git clone git@github.com:nko5/an-ode-to-node.git && cd ./an-ode-to-node/
...
# deploying to Modulus (to http://an-ode-to-node.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/an-ode-to-node" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
